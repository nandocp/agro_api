...
# from rspec.factories.core import UserFactory
# from rspec.factories.estates import EstateFactory
...
#     # soil_type_id = factory.LazyAttribute(lambda obj: str(obj.soil_type.id))
...
#     # soil_type = factory.SubFactory(SoilTypeFactory)
