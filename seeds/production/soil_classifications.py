...
from app.domain.fields.models import SoilClassification
...
SOIL_CLASSIFICATIONS = [
    ...
    # Ordens (nível 1)
    {
        ...
        'parent': None,
        'description': (
            'Solos com horizonte B textural com argila de atividade baixa'
        ),
    },
    {
        'name': 'Cambissolos',
    ...
    },
    {
        ...
        'parent': None,
        'description': (
            'Solos com horizonte A chernozêmico e argila de atividade alta'
        ),
    },
    {
        'name': 'Espodossolos',
    ...
    },
    {
        ...
        'parent': None,
        'description': (
            'Solos com horizonte B latossólico, altamente intemperizados'
        ),
    },
    {
        'name': 'Luvissolos',
        ...
        'parent': None,
        'description': (
            'Solos com horizonte B textural com argila de atividade alta'
        ),
    },
    {
        'name': 'Neossolos',
        ...
        'parent': None,
        'description': (
            'Solos com pequena expressão dos processos pedogenéticos'
        ),
    },
    {
        'name': 'Nitossolos',
    ...
    },
    {
        ...
        'parent': None,
        'description': (
            'Solos com mudança textural abrupta e horizonte adensado'
        ),
    },
    {
        'name': 'Plintossolos',
    ...
    # Reference Soil Groups (nível 1)
    {
        ...
        'parent': None,
        'description': (
            'Soils with low activity clay accumulation: strongly weathered'
        ),
    },
    {
        'name': 'Alisols',
        ...
        'parent': None,
        'description': (
            'Soils with high activity clay accumulation '
    ...
    },
    {
        ...
        'parent': None,
        'description': (
            'Black soils with high organic matter and base saturation'
        ),
    },
    {
        'name': 'Ferralsols',
        ...
        'parent': None,
        'description': (
            'Highly weathered tropical soils: equivalent to Latossolos'
        ),
    },
    {
        'name': 'Fluvisols',
    ...
    },
    {
        ...
        'parent': None,
        'description': (
            'Soils with low activity clay accumulation '
    ...
    },
    {
        ...
        'parent': None,
        'description': (
            'Soils with abrupt textural change and stagnic conditions'
        ),
    },
    {
        'name': 'Plinthosols',
    ...
    },
    {
        ...
        'parent': None,
        'description': (
            'Soils with dark organic-rich horizon and low base saturation'
        ),
    },
    {
        'name': 'Vertisols',
...
async def seed(session: AsyncSession) -> None:
    for item in SOIL_CLASSIFICATIONS:
        ...
        await session.execute(
            ...
            .on_conflict_do_nothing(constraint='uq_soil_name_source')
        )
    await session.flush()
    ...
    for item in SOIL_CLASSIFICATIONS:
        ...
        parent = await session.scalar(
            select(SoilClassification).where(
                SoilClassification.name == item['parent'].lower(),
                SoilClassification.source == source,
            )
        )
        if not parent:
