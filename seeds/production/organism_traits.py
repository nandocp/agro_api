...
# not classified as GMO in Brazil (CTNBio)',
#     },
#     {
#         'name': 'synthetic',
#         'category': TraitCategory.BREEDING_METHOD,
...
#         'description': 'Traditional variety adapted locally
#  — regional/cultural connotation',
#     },
#     {
#         'name': 'landrace',
#         'category': TraitCategory.ORIGIN,
#         'description': 'Traditional variety developed over
#  generations in specific region',
#     },
#     {
#         'name': 'heirloom',
#         'category': TraitCategory.ORIGIN,
...
# biodynamic production philosophy',
#     },
#     {
