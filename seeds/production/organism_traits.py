...
from app.domain.organisms.enums import TraitCategory
from app.domain.organisms.models import OrganismTrait
...
INITIAL_TRAITS = [
    ...
    },
    {
        ...
        'category': TraitCategory.BREEDING_METHOD,
        'description': (
            'CRISPR/TALEN edited. Not classified as GMO in Brazil (CTNBio)'
        ),
    },
    {
        'name': 'synthetic',
    ...
    # Origin
    {
        ...
        'description': (
            'Traditional variety adapted locally. '
            'Regional/cultural connotation'
        ),
    },
    {
        'name': 'landrace',
        'category': TraitCategory.ORIGIN,
        'description': (
            'Traditional variety developed over generations in specific region'
        ),
    },
    {
        'name': 'heirloom',
    ...
    # Resistance
    {
        ...
        'description': 'Tolerant to specific herbicides. Ex: RR, Liberty Link',
    },
    {
    ...
    # Adaptation
    {
        ...
        'description': 'Adapted to tropical climate. Ex: zebu base',
    },
    {
        'name': 'temperate_adapted',
        'category': TraitCategory.ADAPTATION,
        'description': 'Adapted to temperate climate. Ex: taurine base',
    },
]
